...
func (e *Evaluator) Evaluate(ctx context.Context, req *EvaluationRequest) (*Decision, error) {
	...
	for _, policy := range policies {
		...
		} else if decision.Action == ActionEscalate {
		...
		} else if decision.Action == ActionRequireApproval {
		...
		} else if decision.Action == ActionWarn {
...
func (e *Evaluator) evaluateRule(ctx context.Context, rule *PolicyRule, evalCtx *EvaluationContext) (bool, bool, string, error) {
